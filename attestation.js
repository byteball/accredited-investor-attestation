...
const privateProfile = require('ocore/private_profile');
						...
						db.query(
							...
							(res) => {
								...
								if (conf.referralRewardInUSD) {
									...
									reward.findReferrer(row.payment_unit, (referring_vi_user_id, referring_user_address, referring_user_device_address) => {
